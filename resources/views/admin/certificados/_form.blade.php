<form action="{{ isset($certificado) ? route('admin.certificados.update', $certificado) : route('admin.certificados.store') }}"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <select id="modalidad" name="modalidad" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('modalidad') border-red-500 @enderror">
