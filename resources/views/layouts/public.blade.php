...
<body class="bg-gray-50 text-gray-800 font-sans antialiased">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-blue-200">
                        ...
                        <li class="flex items-start gap-2">
                            ...
                            academiasstcolombiana@gmail.com
                        </li>
                    </ul>
    ...
    <a href="https://wa.me/573212173463" target="_blank" class="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg transition z-50 wa-pulse" aria-label="Contactar por WhatsApp">
