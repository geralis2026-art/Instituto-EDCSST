        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="ml-3 px-4 py-2 text-sm font-medium bg-gray-800 text-white rounded-md hover:bg-gray-900 transition">
                ...
                {{-- Botón menú móvil --}}
                <button id="mobile-menu-btn" class="md:hidden p-2 text-gray-700 hover:bg-gray-100 rounded-md">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-blue-100">
                        ...
                        <li class="flex items-start"><span class="mr-2">✉️</span> contacto@edcsst.com</li>
                    </ul>

                    <div class="flex space-x-3 mt-4">
                        <a href="#" class="bg-blue-800 hover:bg-blue-700 p-2 rounded-full transition" aria-label="Facebook">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                        <a href="#" class="bg-blue-800 hover:bg-blue-700 p-2 rounded-full transition" aria-label="Instagram">
                        ...
                        <a href="https://wa.me/573212173463" target="_blank" class="bg-green-600 hover:bg-green-500 p-2 rounded-full transition" aria-label="WhatsApp">
